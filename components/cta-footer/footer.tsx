...
const defaultAvatars: Avatar[] = [
    ...
    { avatar: "https://media.licdn.com/dms/image/v2/D4D03AQEBQKETjjhcAQ/profile-displayphoto-crop_800_800/B4DZeDaIppGYAM-/0/1750256357245?e=1772064000&v=beta&t=FoIm5lyaBsL1-qAkctU_RrYoQEr-YrTCkAWUk58RGWM", name: "Founder_Omkar" },
    { avatar: "https://avatars.githubusercontent.com/u/23276437?v=4", name: "Manu Paaji" },
    { avatar: "https://media.licdn.com/dms/image/v2/C5603AQFbOqG9og1S5g/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1517251238442?e=1772064000&v=beta&t=UhgpUGAqMFgUjsWWzdyi7182glr0QkTxDiEVrQegnNg", name: "Harkirat" },
...
export function MaskedAvatars({
    ...
    return (
        ...
        >
            ...
            <AnimatedShinyText className="text-center max-w-full w-full block py-4 ">
                Build by SKB & Omkar . The source code is available on GitHub.
            </AnimatedShinyText>
        </div>
    )
}